...
<div id="my-account">
    <span>
        ...
        <!-- Check for welcome message or firstname cookie -->
        ...
        if (isset($_SESSION['loggedin'])) {
            ...
            echo '<a href="/acme/accounts?action=login"><img src="/acme/images/site/account.gif" alt="My Account">My Account</a></span>';
        }
        ?>
</div>
